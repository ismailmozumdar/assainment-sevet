...
const qustion = () =>{
  ...
  <h1 class="text-center m-3">ইভেন্ট লুপ কিভাবে কাজ করে?</h1>
  <p>ইভেন্ট লুপ এমন কিছু অভ্যন্তরীণ বা বাহ্যিক "ইভেন্ট প্রদানকারী" এর কাছে একটি অনুরোধ করে কাজ করে, যা সাধারণত একটি ইভেন্ট না আসা পর্যন্ত অনুরোধটিকে ব্লক করে, ইভেন্ট হ্যান্ডলারকে কল করে "ইভেন্টটি পাঠায়। এর যতগুলো উপাদান রয়েছে প্রত্যেকের জন্য একবার করে তার প্রক্রিয়াটি চলে</p>`
